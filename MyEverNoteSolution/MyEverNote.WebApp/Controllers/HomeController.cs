...
namespace MyEverNote.WebApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        public object CategoryManager { get; private set; }
        ...
        public ActionResult ByCategory(int? id)
        {
            ...
            Category cat = cm.GetCategoryById(id.Value); //yukarıda ? koyduğumuz için tip uyuşmazlığı oldu. O yüzden de value aldık.
            if (cat==null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Login(LoginViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (res.Errors.Count>0)
                {
                    ...
                    {
                        ViewBag.SetLink = "http://Home/Activate/1234-4567-789000";
                    }
